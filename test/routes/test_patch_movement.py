...
class TestPatchMove:
    ...
    def test_use_movement_card(self, mocker, card_id, 
        ...
        mock_move_service = mocker.patch("app.routes.game.MoveService.set_parcial_movement")
        ...
        response = client.patch(f"/games/movement-cards/{card_id}", json=movement_request.model_dump())
